...
class AnonEnv:
    ...
    #     len_queue_num = list(lane_q_length.values())
    #     all_queue = sum(len_queue_num)
    #
    #     return all_queue
    ...
    def reset(self):
        ...
        # init roadnet
        path_road_net = os.path.join(self.path_to_work_directory, cityflow_config['roadnetFile'])
        self.roadnet = self._get_roadnet(path_road_net)
        self.all_lanes = []
    ...
    def _get_roadnet(self, roadnet_file):
